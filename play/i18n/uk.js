...
export default {
	...
	'Press ENTER to submit, type 0 to cancel':
		'Натисніть ENTER для відправки, введіть 0 для скасування',
	'Cancelled.': 'Скасовано.',
	...
	'Invalid phone number. Use digits only, 7‑15 characters.':
		'Неправильний номер телефону. Використовуйте лише цифри, 7-15 символів.',
